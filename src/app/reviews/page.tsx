...
const reviews = [
  {
    ...
    tags: ["Emergency", "Heating", "Repair"],
    highlight: "Below-zero furnace call",
  },
  {
    name: "Chris Noeldner",
    location: "Watertown, SD",
    ...
    tags: ["Installation", "Heating"],
    highlight: "Clean install, right on schedule",
  },
  {
    name: "Zachary Ninke",
    location: "Watertown, SD",
    ...
    tags: ["Repair", "Heating"],
    highlight: "Detailed troubleshooting",
  },
  {
    name: "Andrew Sebek",
    location: "Watertown, SD",
    ...
    highlight: "Fast response, fast fix",
  },
  {
    name: "Zachary Ordal",
    location: "Watertown, SD",
    ...
    tags: ["Emergency", "Cooling", "Repair"],
    highlight: "Next-morning AC rescue",
  },
  {
    name: "Chad Telford",
    location: "Watertown, SD",
    ...
    tags: ["Installation", "Cooling", "Heating"],
    highlight: "New-system recommendation",
  },
  {
    name: "Kristen Hurkes",
    location: "Watertown, SD",
  ...
  },
  {
    ...
    highlight: "Clear install communication",
  },
];
